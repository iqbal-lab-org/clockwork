...
# which are used to test the nextflow variant_call pipeline.
...
fastaq to_perfect_reads --seed 45 $tmp_ref_dir/mutated.fa - 200 1 20 75 | fastaq deinterleave - tmp.reads.1.ref.1.fq tmp.reads.1.ref.2.fq
...
fastaq to_perfect_reads --seed 47 $tmp_ref_dir/mutated.fa - 200 1 20 75 | fastaq deinterleave - tmp.reads.2.ref.1.fq tmp.reads.2.ref.2.fq
...
fastaq to_perfect_reads --seed 49 $tmp_ref_dir/mutated2.fa - 200 1 20 75 | fastaq deinterleave - tmp.reads.3.ref.1.fq tmp.reads.3.ref.2.fq
...
fastaq to_perfect_reads --seed 51 $tmp_ref_dir/mutated2.fa - 200 1 20 75 | fastaq deinterleave - tmp.reads.4.ref.1.fq tmp.reads.4.ref.2.fq
...
fastaq to_perfect_reads --seed 53 $tmp_ref_dir/mutated2.fa - 200 1 20 75 | fastaq deinterleave - tmp.reads.5.ref.1.fq tmp.reads.5.ref.2.fq
