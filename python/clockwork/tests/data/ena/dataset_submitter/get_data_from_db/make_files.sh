...
p1,s1,l1,42,43,20171225,$dropbox/reads.1.1.fq.gz,0,$dropbox/reads.1.2.fq.gz,0,g1,Illumina HiSeq 2000,Center 42,1,1,0,0
p2,s1,l1,44,1,20171225,$dropbox/reads.2.1.fq.gz,0,$dropbox/reads.2.2.fq.gz,0,g1,Illumina HiSeq 2000,Center 42,1,1,0,0
p2,s1,l1,44,2,20171225,$dropbox/reads.3.1.fq.gz,0,$dropbox/reads.3.2.fq.gz,0,g1,Illumina HiSeq 2000,Center 42,1,1,0,0
p3,s2,l1,48,49,20171225,$dropbox/reads.4.1.fq.gz,0,$dropbox/reads.4.2.fq.gz,0,g2,Illumina HiSeq 2000,Center 42,1,1,0,0" | sed 's/,/\t/g' > $import_tsv
...
rm $pipeline_root/00/00/00/03/3/Reads/reads.remove_contam.49.1.fq.gz
rm $pipeline_root/00/00/00/03/3/Reads/reads.remove_contam.49.2.fq.gz
echo "whoops" | gzip -c > $pipeline_root/00/00/00/03/3/Reads/reads.remove_contam.49.1.fq.gz
echo "covfefe" | gzip -c > $pipeline_root/00/00/00/03/3/Reads/reads.remove_contam.49.2.fq.gz
