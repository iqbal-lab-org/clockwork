...
class TestFastqc(unittest.TestCase):
    ...
    def test_seq_length_from_report_string(self):
        ...
        self.assertEqual(
            (10, 42), fastqc.Fastqc._seq_length_from_report_string("10-42")
        )
    ...
    def test_gather_all_stats(self):
        ...
        stats1 = fastqc.Fastqc._stats_from_report(
            os.path.join(indir, "fastqc_reads_1_fastqc", "fastqc_data.txt")
        )
        stats1.pop("filename")
        stats2 = fastqc.Fastqc._stats_from_report(
            os.path.join(indir, "fastqc_reads_2_fastqc", "fastqc_data.txt")
        )
        stats2.pop("filename")
        expected = {"fastqc_reads_1.fq": stats1, "fastqc_reads_2.fq": stats2}
        self.assertEqual(expected, got)
    ...
    def test_run(self):
        ...
        stats1.pop("filename")
        stats2.pop("filename")
        expected_stats = {"reads_1.fq": stats1, "reads_2.fq": stats2}
        self.maxDiff = None
