...
import os
import shutil
from clockwork import db, db_connection, db_maker, isolate_dir, read_pair_importer, utils, fqtools
...
class TestReadPairImporter(unittest.TestCase):
    ...
    def test_copy_reads_file(self):
        ...
        read_pair_importer.ReadPairImporter._copy_reads_file(original_reads_file, tmp_reads_file, correct_md5)
        ...
        with self.assertRaises(read_pair_importer.Error):
            read_pair_importer.ReadPairImporter._copy_reads_file(original_reads_file, tmp_reads_file, 'wrong md5')
    ...
    def test_check_database(self):
        ...
        seqrep_row = {'seqrep_id': 1, 'isolate_id': 1, 'sequence_replicate_number' : 1,
    ...
    def test_update_database(self):
        ...
        seqrep_row = {'seqrep_id': None, 'isolate_id': 1, 'sequence_replicate_number' : 3,
            'original_reads_file_1_md5': 'md51', 'original_reads_file_2_md5': 'md52',
            'remove_contam_reads_file_1_md5': None, 'remove_contam_reads_file_2_md5': None,
            'withdrawn': 0, 'import_status': 0, 'instrument_model': 'Illumina HiSeq 2000',
            'submission_date': '20170101', 'submit_to_ena': 0, 'ena_run_accession': None, 'ena_on_hold': 0}
        ...
        read_pair_importer.ReadPairImporter._update_database(self.db, 1, 1, 3, import_status=42)
