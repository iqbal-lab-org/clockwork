...
class TestFakeContamRemover(unittest.TestCase):
    ...
    def test_symlink_reads_file(self):
        ...
        with self.assertRaises(fake_contam_remover.Error):
            fake_contam_remover.FakeContamRemover._symlink_reads_file(file_to_symlink, symlink_name)
        ...
        with self.assertRaises(fake_contam_remover.Error):
            fake_contam_remover.FakeContamRemover._symlink_reads_file(file_to_symlink, 'bar')
    ...
    def test_run(self):
        ...
        cremover = fake_contam_remover.FakeContamRemover(reads1, reads2, link1, link2, counts_file)
        cremover.run()
