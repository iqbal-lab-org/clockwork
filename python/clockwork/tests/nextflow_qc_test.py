...
class TestNextflowQc(unittest.TestCase):
    def test_nextflow_qc_using_database(self):
        ...
        expected_qc_rows = [
            {
                ...
                "samtools_positions_with_depth_atleast_10": 562,
                "samtools_positions_with_depth_atleast_100": 0,
                "samtools_positions_with_depth_atleast_2": 968,
                "samtools_positions_with_depth_atleast_20": 0,
                "samtools_positions_with_depth_atleast_5": 876,
                "samtools_positions_with_depth_of_0": 17,
            ...
            },
            {
                ...
                "samtools_outward_oriented_pairs": 0,
                "samtools_pairs_with_other_orientation": 0,
                "samtools_positions_with_depth_atleast_10": 547,
                "samtools_positions_with_depth_atleast_100": 0,
                "samtools_positions_with_depth_atleast_2": 955,
                "samtools_positions_with_depth_atleast_20": 0,
                "samtools_positions_with_depth_atleast_5": 902,
                "samtools_positions_with_depth_of_0": 17,
                "samtools_raw_total_sequences": 144,
        ...
        for id_dict in ids:
            ...
            qc_root_dir = iso_dir.pipeline_dir(
                id_dict["seq_repl"], "qc", clockwork_version
            )
